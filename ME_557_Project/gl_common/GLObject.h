...
public:
	...
	inline glm::mat4& getModelMatrix(void){ return _modelMatrix; }; // returns Model Matrix

	bool keystrokes1(int key_stroke);
	bool keystrokes2(int key_stroke);
	bool keystrokes3(int key_stroke);
	bool keystrokes4(int key_stroke);
	bool keystrokes_init(int key_stroke, glm::mat4& matrix);
