...
GLObject::GLObject()
{
    ...
    g_projectionMatrix = glm::perspective(1.0f, (float)1366 / (float)720, 0.1f, 10000.f);
...
/*
void GLObject::init_model(glm::mat4& matrix)
{
	_modelMatrix = matrix;
}
*/

bool GLObject::keystrokes_init(int key_stroke, glm::mat4& matrix)
{
	if ((key_stroke == 1) && (key_stroke != key_change0))
	{
		setMatrix(matrix);
		return true;
	}
...
bool GLObject::keystrokes1(int key_stroke) // translate_up key
{
	if ((key_stroke >= 1) && (key_stroke != key_change1))
	{
		glm::mat4 translate_1step = glm::translate(glm::vec3(0.0f, 1.0f, 0.0f));
		glm::mat4 new_loc = getModelMatrix();
		glm::mat4 tran_mat = translate_1step * new_loc;
		setMatrix(tran_mat);
		key_change1 = key_stroke;
		return true;
	}
	else
		return false;
...
bool GLObject::keystrokes2(int key_stroke) // translate_down key
{
	if ((key_stroke >= 1) && (key_stroke != key_change2))
	{
		glm::mat4 translate_1step = glm::translate(glm::vec3(0.0f, -1.0f, 0.0f));
		glm::mat4 new_loc = getModelMatrix();
		glm::mat4 tran_mat = translate_1step * new_loc;
		setMatrix(tran_mat);
		key_change2 = key_stroke;
		return true;
	}
	else return false;
}

bool GLObject::keystrokes3(int key_stroke) //translate_left key
{
	if ((key_stroke >= 1) && (key_stroke != key_change3))
	{
		glm::mat4 rotate_1step = glm::rotate(0.1f, glm::vec3(0.0f, -1.0f, 0.0f));
		glm::mat4 new_loc = getModelMatrix();
		glm::mat4 tran_mat = rotate_1step * new_loc;
		setMatrix(tran_mat);
		key_change3 = key_stroke;
		return true;
	}
	else return false;
}

bool GLObject::keystrokes4(int key_stroke) //translate_right key
{
	if ((key_stroke >= 1) && (key_stroke != key_change4))
	{
		glm::mat4 rotate_1step = glm::rotate(0.1f, glm::vec3(0.0f, 1.0f, 0.0f));
		glm::mat4 new_loc = getModelMatrix();
		glm::mat4 tran_mat = rotate_1step * new_loc;
		setMatrix(tran_mat);
		key_change4 = key_stroke;
		return true;
	}
	else return false;
}
...
{
	glm::mat4 init_rotatedview = g_rotated_view;
