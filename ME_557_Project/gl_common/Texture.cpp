...
string  GLMultiTexture::_glsl_names[4] = { "texture_background", "texture_foreground", "texture_blend", "texture_3"};
#endif
...
bool GLTexture::addNewMat(GLuint program, int variable_index, int tex)
{
...
bool GLMultiTexture::addVariablesToProgram(GLuint program, int variable_index)
{
	...
	checkUniform(_textureIdx2, _glsl_names[3]);
